...
public class DossierController {
    ...
    public ResponseEntity<?> createDossier(
            ...
            @RequestParam(required = false) Integer dureeRealisation,
        ...
        try {
            ...
            DossierCME dossier = dossierService.createDossier(
                    numeroDossier, intitule, typePassation, montantEstime, budgetEstime, dureeContrat, dureeRealisation,
    ...
    public ResponseEntity<?> updateDossier(
        ...
        try {
            DossierCME updatedDossier = dossierService.updateDossier(
                    id, numeroDossier, intitule, typePassation, montantEstime, budgetEstime, dureeContrat, dureeRealisation,
